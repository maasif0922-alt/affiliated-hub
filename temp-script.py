...
# Write down the new JSON into a temp file
with open('c:/Users/PC/Desktop/affliated program website/affiliated-hub/temp-data.json', 'w') as f:
    json.dump(user_data, f, indent=2)

print("temp-data.json fully written via python.")
